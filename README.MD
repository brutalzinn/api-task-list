...
This project is designed to my estudies case of hypermedia REST apis(HATEOAS) and now oauth2 flux handle. This project is a overthink project. Why? Because i can.
