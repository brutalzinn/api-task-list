...
func Get(w http.ResponseWriter, r *http.Request) {
	...
	Repos, err := repo_service.Get(int64(id))
	if err != nil {
...
func Update(w http.ResponseWriter, r *http.Request) {
	...
	rows, err := repo_service.Update(int64(id), repo)
	if err != nil {
...
func Paginate(w http.ResponseWriter, r *http.Request) {
	...
	offset := (page - 1) * limit
	repos, err := repo_service.Paginate(limit, offset, order)
	if err != nil {
...
func Delete(w http.ResponseWriter, r *http.Request) {
	...
	rows, err := repo_service.Delete(int64(id))
	if err != nil {
